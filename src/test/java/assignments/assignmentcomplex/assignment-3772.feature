...
Scenario Outline: DA init pacs.008, DA pass screening, DA's node status: <daDownNode>, CA's node status: <caDownNode>, IA's node status: <iaDownNode>, Both CA and IA send pacs.002 ACSP, DA stop payment, node(s) up
  ...
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Admi004-QRTY.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Admi004-RESM-Camt056.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Admi007-ACTC.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-CA-Receive-Camt056.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-IA-Receive-Camt056.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-CA-Receive-Admi004-RESM-Pacs002.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-IA-Receive-Admi004-RESM-Pacs002.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Pacs002-ACSP.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Camt029-CNCL.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-DA-Receive-Pacs002-CANC.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-CA-Receive-Pacs002-CANC.feature', requestParameters)
  * karate.call('classpath:assignments/assignmentcomplex/assignment-IA-Receive-Pacs002-CANC.feature', requestParameters)
